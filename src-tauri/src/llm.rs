...
//! Mesmo padrão dos irmãos da suíte; o LocalDraw prefere a porta 8106
//! (Writer=8088, Code=8090+, Sheets=8099+, Slides=8100+, LocalData=8101+,
//! LocalPDF=8102+, TaylorChat=8103+, LocalAgenda=8104+, LocalScribe=8105+).
...
/// LocalDraw prefere 8106; cai pra próxima livre da faixa se ocupada.
fn pick_free_port() -> Result<u16, String> {
    for port in 8106u16..=8126 {
        if TcpListener::bind(("127.0.0.1", port)).is_ok() {
            return Ok(port);
        }
    }
    Err("nenhuma porta livre entre 8106 e 8126 para a IA".into())
}
